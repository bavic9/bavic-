  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <Tilt
        ...
        className="bg-tertiary px-5 py-10 rounded-2xl sm:w-[360px] w-full"
      >
        <div
        ...
        <div className="mt-5">
          ...
          <p className="mt-2 text-sm md:text-base text-text text-[14px]">{description}</p>
        </div>
      ...
      <div className=" lg:w-[80vw] mx-auto my-20 lg:my-20">
        ...
        <div className="w-full flex">
          <motion.p
            ...
            className="mt-3 text-text text-sm md:text-base leading-[30px]"
          >
